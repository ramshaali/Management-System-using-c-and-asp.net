<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm10.aspx.cs" Inherits="db_project.WebForm10" %>
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-md" id="app-navbar">
        <div class="container-fluid"><a class="navbar-brand" href="#"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><asp:LinkButton class="btn btn-info btn-sm text-capitalize" type="button" ID="LinkButton2" runat="server" Height="62px" OnClick="LinkButton2_Click" Width="91px"><br>HomePage<br></asp:LinkButton>
    ...
    <section class="features-blue">
        <div class="container">
            ...
            <div class="intro">
                <h3 class="display-4 text-center text-info">Fyp Request Decision Form</h3>
        ...
        <div class="degree_issuance">
            ...
            &nbsp;&nbsp &nbsp<asp:TextBox ID="TextBox23" runat="server"></asp:TextBox>
              <br>
            &nbsp;<label for="reg">FYP Request no: </label>
