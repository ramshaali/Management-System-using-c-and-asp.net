        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                using (SqlCommand cmdd = new SqlCommand("SELECT a_name,id FROM admin WHERE  logged_in = 1"))
                {
                    ...
                    SqlDataAdapter da = new SqlDataAdapter("select token as Token#, student.s_name as Student_Name from student, one_stop,degree_form, admin where student.s_id = degree_form.s_id and one_stop.form_id = degree_form.s_id and  f_status=5 and admin.logged_in=1 ", con);
